...
const getOgImgComponent = (route) => {
    ...
    OgImg = (
      <div
        style={{
          ...
          ...twj('w-full h-full flex flex-col justify-between p-12 shadow-2xl shadow-gray-100 bg-repeat')
        }}
      >
  ...
  OgImg = (
    ...
    >
      <div style={twj('flex h-[8%] w-full items-center justify-between shadow-2xl shadow-gray-100')}>
