...
import { ArrowUpToLine, BookText, Hash, List, Pin, Share, SquareLibrary } from 'lucide-react'
...
const ArticleActions = (props) => {
  ...
  return (
    <>
      ...
      >
        <Pin
          className={clx('transition cursor-pointer fill-black dark:fill-white stroke-black dark:stroke-white', {
            'rotate-45': !isPinned
          })}
        />
      </div>
      <div
        className={clx('flex w-full justify-center transition-all', {
          'sticky bottom-10 left-0': isPinned
        })}
      >
        <div
          className={`
